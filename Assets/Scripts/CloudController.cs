    ...
    public class CloudController : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (Application.platform != RuntimePlatform.IPhonePlayer)
            {
                ...
                //Creating an Anchor with the session

                m_LastPlacedAnchor = Session.CreateAnchor(Frame.Pose);
        ...
        public void OnResolveRoomClick()
        {
            ...
            //ClientScene.RegisterPrefab(ARCoreAndyAndroidPrefab);
        ...
        private void _ResolveAnchorFromId(string cloudAnchorId)
        {
            XPSession.ResolveCloudAnchor(cloudAnchorId).ThenAction((System.Action<CloudAnchorResult>)(result =>
            {
                ...
                var player = Instantiate(_GetAndyPrefab(), result.Anchor.transform);
