...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class CustomHandDraggable : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        ...
        {
            string path = Path.Combine(Application.persistentDataPath, "Line.obj");
            var lStream = new FileStream(path, FileMode.Create);
